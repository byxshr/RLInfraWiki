---
id: failure-partial-weight-update
title: Partial weight update
type: failure-mode
page_type: failure-mode
components:
- weight-sync
summary: Some rollout engines or tensor buckets observe newer weights while others
  do not.
sources:
...
## Failure description
Some rollout engines or tensor buckets observe newer weights while others do not.
