...
summary: RLOO page focuses on infra contracts, required sample fields, rollout requirements,
...
RLOO requires framework-specific rollout and trainer plumbing to preserve algorithm data semantics.
