...
summary: GRPO page focuses on infra contracts, required sample fields, rollout requirements,
...
GRPO requires framework-specific rollout and trainer plumbing to preserve algorithm data semantics.
