...
summary: RLVR page focuses on infra contracts, required sample fields, rollout requirements,
...
RLVR requires framework-specific rollout and trainer plumbing to preserve algorithm data semantics.
