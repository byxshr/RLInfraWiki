---
id: capability-policy-versioning
...
relations:
  ...
  - framework-roll
  - framework-areal
summary: Policy versioning is an RL infrastructure capability with explicit adapter
...
## Definition
Policy versioning describes a reusable RL infrastructure capability rather than a single framework implementation.
