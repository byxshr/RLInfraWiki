---
id: capability-rollout-logprob-capture
title: Rollout logprob capture
type: capability
...
relations:
  ...
  - framework-roll
  - framework-areal
summary: Rollout logprob capture is an RL infrastructure capability with explicit
...
# Rollout logprob capture

## Definition
Rollout logprob capture describes a reusable RL infrastructure capability rather than a single framework implementation.
