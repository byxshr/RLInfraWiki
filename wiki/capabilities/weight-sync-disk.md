---
id: capability-weight-sync-disk
title: Disk checkpoint weight sync
type: capability
...
relations:
  ...
  - framework-roll
  - framework-areal
summary: Disk checkpoint weight sync is an RL infrastructure capability with explicit
...
# Disk checkpoint weight sync

## Definition
Disk checkpoint weight sync describes a reusable RL infrastructure capability rather than a single framework implementation.
