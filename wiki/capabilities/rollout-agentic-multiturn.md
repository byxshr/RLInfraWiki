---
id: capability-rollout-agentic-multiturn
title: Agentic multi-turn rollout
type: capability
...
relations:
  ...
  - framework-roll
  - framework-areal
summary: Agentic multi-turn rollout is an RL infrastructure capability with explicit
...
## Definition
Agentic multi-turn rollout describes a reusable RL infrastructure capability rather than a single framework implementation.
