---
id: capability-rollout-server-async
title: Asynchronous rollout server
type: capability
...
relations:
  ...
  - framework-roll
  - framework-areal
summary: Asynchronous rollout server is an RL infrastructure capability with explicit
...
# Asynchronous rollout server

## Definition
Asynchronous rollout server describes a reusable RL infrastructure capability rather than a single framework implementation.
