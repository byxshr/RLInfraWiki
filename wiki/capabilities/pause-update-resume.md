---
id: capability-pause-update-resume
title: Pause update resume lifecycle
type: capability
...
relations:
  ...
  - framework-roll
  - framework-areal
summary: Pause update resume lifecycle is an RL infrastructure capability with explicit
...
# Pause update resume lifecycle

## Definition
Pause update resume lifecycle describes a reusable RL infrastructure capability rather than a single framework implementation.
