---
id: capability-data-buffer-trajectory
title: Trajectory data buffer
type: capability
...
relations:
  ...
  - framework-roll
  - framework-areal
summary: Trajectory data buffer is an RL infrastructure capability with explicit adapter
...
# Trajectory data buffer

## Definition
Trajectory data buffer describes a reusable RL infrastructure capability rather than a single framework implementation.
