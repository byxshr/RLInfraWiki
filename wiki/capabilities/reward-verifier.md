---
id: capability-reward-verifier
title: Reward verifier service
type: capability
...
relations:
  ...
  - framework-roll
  - framework-areal
summary: Reward verifier service is an RL infrastructure capability with explicit
...
## Definition
Reward verifier service describes a reusable RL infrastructure capability rather than a single framework implementation.
