---
id: capability-weight-sync-distributed
title: Distributed weight synchronization
type: capability
...
relations:
  ...
  - framework-roll
  - framework-areal
summary: Distributed weight synchronization is an RL infrastructure capability with
  explicit adapter contracts, failure modes, and validation requirements.
sources:
- repo-thudm-slime-readme
...
## Definition
Distributed weight synchronization describes a reusable RL infrastructure capability rather than a single framework implementation.
