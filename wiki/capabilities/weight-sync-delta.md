---
id: capability-weight-sync-delta
title: Delta weight synchronization
type: capability
...
relations:
  ...
  - framework-roll
  - framework-areal
summary: Delta weight synchronization is an RL infrastructure capability with explicit
...
## Definition
Delta weight synchronization describes a reusable RL infrastructure capability rather than a single framework implementation.
