---
id: capability-rollout-batched-sync
title: Batched synchronous rollout
type: capability
...
relations:
  ...
  - framework-roll
  - framework-areal
summary: Batched synchronous rollout is an RL infrastructure capability with explicit
...
# Batched synchronous rollout

## Definition
Batched synchronous rollout describes a reusable RL infrastructure capability rather than a single framework implementation.
