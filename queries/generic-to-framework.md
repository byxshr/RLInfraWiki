# Query: Generic To Framework

> Auto-generated. Do not edit manually.

| generic page | frameworks | sources |
|---|---|---|
| `algorithm-agentic-rl` |  | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `repo-verl-readme`, `repo-alibaba-roll-readme`, `repo-inclusionai-areal-readme` |
| `algorithm-dapo` |  | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `repo-verl-readme`, `repo-alibaba-roll-readme`, `repo-inclusionai-areal-readme` |
| `algorithm-grpo` |  | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `repo-verl-readme`, `repo-alibaba-roll-readme`, `repo-inclusionai-areal-readme` |
| `algorithm-gspo` |  | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `repo-verl-readme`, `repo-alibaba-roll-readme`, `repo-inclusionai-areal-readme` |
| `algorithm-ppo` |  | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `repo-verl-readme`, `repo-alibaba-roll-readme`, `repo-inclusionai-areal-readme` |
| `algorithm-reinforce-plus-plus` |  | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `repo-verl-readme`, `repo-alibaba-roll-readme`, `repo-inclusionai-areal-readme` |
| `algorithm-rloo` |  | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `repo-verl-readme`, `repo-alibaba-roll-readme`, `repo-inclusionai-areal-readme` |
| `algorithm-rlvr` |  | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `repo-verl-readme`, `repo-alibaba-roll-readme`, `repo-inclusionai-areal-readme` |
| `capability-checkpoint-conversion` | `slime`, `verl`, `roll`, `areal` | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `repo-verl-readme`, `repo-alibaba-roll-readme`, `repo-inclusionai-areal-readme` |
| `capability-data-buffer-trajectory` | `slime`, `verl`, `roll`, `areal` | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `repo-verl-readme`, `repo-alibaba-roll-readme`, `repo-inclusionai-areal-readme` |
| `capability-pause-update-resume` | `slime`, `verl`, `roll`, `areal` | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `source-slime-weight-sync-code`, `source-sglang-rl-weight-update-refs` |
...
| `capability-sample-grouping` | `slime`, `verl`, `roll`, `areal` | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `repo-verl-readme`, `repo-alibaba-roll-readme`, `repo-inclusionai-areal-readme` |
| `capability-weight-sync-delta` | `slime`, `verl`, `roll`, `areal` | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `source-slime-weight-sync-code`, `source-sglang-rl-weight-update-refs` |
| `capability-weight-sync-disk` | `slime`, `verl`, `roll`, `areal` | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `source-slime-weight-sync-code`, `source-sglang-rl-weight-update-refs` |
...
| `failure-sample-schema-drift` | `slime`, `verl`, `roll`, `areal` | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `repo-verl-readme`, `repo-alibaba-roll-readme`, `repo-inclusionai-areal-readme` |
...
| `failure-stale-policy-training` | `slime`, `verl`, `roll`, `areal` | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `repo-verl-readme`, `repo-alibaba-roll-readme`, `repo-inclusionai-areal-readme` |
...
| `interface-data-buffer-adapter` |  | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `repo-verl-readme`, `repo-alibaba-roll-readme`, `repo-inclusionai-areal-readme` |
...
| `validation-train-infer-schema-match` |  | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `repo-verl-readme`, `repo-alibaba-roll-readme`, `repo-inclusionai-areal-readme` |
| `validation-weight-version-monotonicity` |  | `repo-thudm-slime-readme`, `doc-sglang-rl-systems`, `source-slime-weight-sync-code`, `source-sglang-rl-weight-update-refs` |
