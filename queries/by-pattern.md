...
| [Ray Multi-Role](../wiki/patterns/ray-multirole.md) | Ray orchestration pattern for explicit roles such as actor_train, actor_infer, reference, reward, placement, schedulers, and validation. |
